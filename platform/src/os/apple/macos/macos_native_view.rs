// Minimal stub implementation for macOS native views
...
/// Trait for macOS native view implementation
/// Implemented by makepad-native-components crate
pub trait MacosNativeViewImpl: Send + Sync {
    fn set_content_view(&mut self, view: ObjcId, dpi: f64);
...
/// Manager for macOS native views (delegates to trait implementation)
pub struct MacosNativeViewManager {
    ...
    pub impl_: Option<Box<dyn MacosNativeViewImpl>>,
}
...
impl MacosNativeViewManager {
    ...
    pub fn set_impl(&mut self, impl_: Box<dyn MacosNativeViewImpl>) {
